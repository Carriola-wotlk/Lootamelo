...
ns.Database.items = {
    ["Mount Hyjal"] = {
        ["Winterchill"] = {
            ...
            [30863] = {name = "Deadly Cuffs", icon = "", dropRate = "15%"},
    ...
    ["Black Temple"] = {
        ["High Warlord Naj'entus"] = {
            [32239] = { name = "Slippers of the Seacaller", icon = "", dropRate = "15%" },
            [32240] = { name = "Guise of the Tidal Lurker", icon = "", dropRate = "16%" },
            [32377] = { name = "Mantle of Darkness", icon = "", dropRate = "15%" },
            [32241] = { name = "Helm of Soothing Currents", icon = "", dropRate = "10%" },
            [32234] = { name = "Fists of Mukoa", icon = "", dropRate = "16%" },
            [32242] = { name = "Boots of Oceanic Fury", icon = "", dropRate = "6%" },
            [32232] = { name = "Eternium Shell Bracers", icon = "", dropRate = "16%" },
            [32243] = { name = "Pearl Inlaid Boots", icon = "", dropRate = "10%" },
            [32245] = { name = "Tide-stomper's Greaves", icon = "", dropRate = "7%" },
            [32238] = { name = "Ring of Calming Waves", icon = "", dropRate = "16%" },
            [32247] = { name = "Ring of Captured Storms", icon = "", dropRate = "16%" },
            [32237] = { name = "The Maelstrom's Fury", icon = "", dropRate = "15%" },
            [32236] = { name = "Rising Tide", icon = "", dropRate = "16%" },
